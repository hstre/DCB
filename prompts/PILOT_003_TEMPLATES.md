# PILOT_003 prompt templates — FROZEN PRE-DATA
...
The placebo A/B distinction exists only in the tool payload: both have `producer_match: null`; `control_code` is respectively `K7M2Q9` or `R4V8N3`.
...
Artifact and canonical-R prompt text are inherited from PILOT_002. All P003 requests use the separately frozen non-thinking request mode.
